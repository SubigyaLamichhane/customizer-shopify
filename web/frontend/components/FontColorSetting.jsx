...
export default function FontColorSetting(props) {
    ...
    const deleteItem = async () => {
        ...
        const response = await fetch(`${API_URL}/delete-text-font-color/${deleteId}`, {
            method: "Delete"
        });
    ...
    // call use effect
    useEffect(async () => {
        const response = await fetch(`${API_URL}/get-text-font-colors`);
    ...
    const saveItem = async () => {
        ...
        const response = await fetch(`${API_URL}/create-text-font-color`, {
            method: 'POST',
